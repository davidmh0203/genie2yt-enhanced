// 기존 파서 코드를 그대로 사용 (Worker에서도 사용 가능하도록 공유)
...
/**
 * Parses Genie Music HTML markup and extracts playlist entries.
 */
export const parseGeniePlaylist = (html: string): ParsedSong[] => {
  ...
  try {
    ...
    console.log(`Error in parseGeniePlaylist: ${error}`);
  }
